  ...
  return (
    <Link
      ...
      className={`text-sm px-3 py-1 rounded-full transition ${
        active ? 'bg:white text-black bg-white' : 'text-white/70 hover:text-white hover:bg-white/10'
      }`}
    >
      {children}
    </Link>
      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[11px] text-white/60">For creators & collaborators</span>
          </div>
        </Link>
        ...
        <nav className="flex items-center gap-1">
          ...
          <NavLink href="/creators">Explore creators</NavLink>
